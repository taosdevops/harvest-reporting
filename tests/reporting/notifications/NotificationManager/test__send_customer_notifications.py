...
def test__send_customer_notifications__assert_method_call_count(num_of_recipients, expected_calls, method_to_assert, recipient_type, mock_reporting_notifications_NotificationManager, mock_harvestapi_customer_HarvestCustomer):
...
def test__send_customer_notifications__assert_called_on_exception__send_exception_channels(method_to_raise_at, exception_to_raise, recipient_type, mock_reporting_notifications_NotificationManager, mock_harvestapi_customer_HarvestCustomer):
    del mock_reporting_notifications_NotificationManager._send_customer_notifications
